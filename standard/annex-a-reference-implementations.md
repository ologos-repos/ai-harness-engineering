...
| [mxh-p](../model-construct/mxh-p/) | N/A — a portability kernel, not a deployment | §16 (canonical mechanism) | Evidence that §16's portability requirement describes a buildable, shippable artifact class: a separately-versioned package multiple independent harnesses actually depend on, not a design aspiration |
