...
Worked realizations against real deployments — beyond the informative examples inline in each clause — live in [`model-construct/`](../../model-construct/): a second, substrate-independent realization of §7, plus dedicated §4/§10/§16 realization files with more depth than those clauses' own inline examples.
