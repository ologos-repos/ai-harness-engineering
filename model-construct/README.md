...
**Status: v0.1 — five entries: four real exemplars (grok-console, mxh-p, thinx-codex, thinx — three of which are running deployments; mxh-p is a package/kernel, not itself a deployment) plus a synthetic composite (the AHES Reference Harness) covering all sixteen domains. Redacted to abstraction level 2026-07-16 — see note below.**
